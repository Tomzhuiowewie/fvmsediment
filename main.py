...
def run_real_case(config_path="config.yaml"):
    ...
    flow_loss_fn = SVEsPhysicsLoss(
        ...
        w_continuity=flow_cfg.w_continuity,
        w_momentum_x=flow_cfg.w_momentum_x,
        w_momentum_y=flow_cfg.w_momentum_y,
    )
    ...
    sediment_loss_fn = SedimentPhysicsLoss(
        ...
        w_transport=sediment_cfg.w_transport,
        ...
        w_bed_initial=sediment_cfg.w_bed_initial,
    ...
    trainer = DecoupledTrainer(
        ...
        joint_flow_weight=training_cfg.get('joint_flow_weight', 1.0),
        joint_sediment_weight=training_cfg.get('joint_sediment_weight', 1.0),
