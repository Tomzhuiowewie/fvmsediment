...
def summarize_config(cfg):
    ...
    return {
        ...
        '水动力': {
            ...
            '连续方程固定权重': flow.w_continuity,
            'x 动量固定权重': flow.w_momentum_x,
            'y 动量固定权重': flow.w_momentum_y,
        },
        '泥沙输运': {
            ...
            '输沙 PDE 权重': sediment.w_transport,
            '初始浓度权重': sediment.w_initial_sediment,
            '初始床变权重': sediment.w_bed_initial,
        ...
        '耦合与停止': {
            ...
            '联合水动力 block 权重': training.get('joint_flow_weight'),
            '联合泥沙 block 权重': training.get('joint_sediment_weight'),
